...
import com.zhou.common.Constant.WareConstant;
...
import com.zhou.gulimail.ware.vo.PurchaseItemDoneVo;
...
public class PurchaseServiceImpl extends ServiceImpl<PurchaseDao, PurchaseEntity> implements PurchaseService {
    ...
    public void received(List<Long> ids) {
        ...
        collect.forEach((item)->{
            List<PurchaseDetailEntity> detailEntities = purchaseDetailService.listByIds(Arrays.asList(item.getId()));
